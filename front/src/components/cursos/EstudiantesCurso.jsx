...
const Toast = ({ message, type = 'success', onClose }) => {
  ...
  return (
        <div className={`fixed bottom-4 right-4 z-50 flex items-center gap-3 px-4 py-3 rounded-xl border shadow-lg max-w-[calc(100vw-2rem)] animate-in slide-in-from-right ${styles[type]}`}>
      {icons[type]}
